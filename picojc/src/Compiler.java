...
class C {
	...
	static byte[] fNarrow = new byte[MAX_FIELDS]; // 0=int-like, 1=byte, 2=char, 3=short, 4=boolean
	...
	static byte[] locType = new byte[MAX_LOCALS]; // 0=int,1=ref,2=object[],3=int[],4=byte[],5=char[],8=short[],9=boolean[]
	static byte[] locNarrow = new byte[MAX_LOCALS]; // 0=int-like, 1=byte, 2=char, 3=short, 4=boolean
