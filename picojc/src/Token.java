class Tk {
	...
	static final int PACKAGE=50, IMPORT=51;
	static final int LBRACE=52, RBRACE=53, LPAREN=54, RPAREN=55;
	static final int LBRACKET=56, RBRACKET=57, SEMI=58, COMMA=59, DOT=60, ENUM=61, ELLIPSIS=62;
