...
public class Native {
    ...
    public static native int  fileReadByte();
    public static native void fileWriteByte(int b);
    public static native int  fileRead(byte[] buf, int off, int len);
    public static native void fileWrite(byte[] buf, int off, int len);
    public static native void fileClose(int mode);
    public static native int  fileDelete(byte[] name, int nameLen);
    public static native int  termInfo(int code);
    public static native int  keyRead();
    public static native int  ticks();
}
