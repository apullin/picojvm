 ...
 *   (a) Copy this file and customize the platform shims, or
 *   (b) Just implement the 6 shim functions and #include "../core.h"
 */

#include <stdint.h>
#include <string.h>

/* --- Tunable capacity (override before compiling if needed) ----------- */
#ifndef PJVM_METHOD_CAP
#define PJVM_METHOD_CAP 128
#endif
#ifndef PJVM_CLASS_CAP
#define PJVM_CLASS_CAP 32
#endif
...
#define PJVM_MAX_STACK 128
#endif
#ifndef PJVM_MAX_LOCALS
#define PJVM_MAX_LOCALS 512
#endif
#ifndef PJVM_MAX_FRAMES
#define PJVM_MAX_FRAMES 32
#endif
